...
shiftMuonTable = cms.EDProducer(
    ...
    stripRphiUnmatchedRecHits=cms.InputTag("siStripMatchedRecHits", "rphiRecHitUnmatched"),
    ...
    # DT propagation can be much less precise before its first barrel update;
    # tracker hits retain the tighter gate.
    # DT compatibility is decided by the covariance-aware estimator.  A
    # negative coarse distance disables the redundant global-distance veto.
    additionalDTMaxDistance=cms.double(-1.0),
    additionalTrackerMaxDistance=cms.double(30.0),
    additionalHitMaxChi2=cms.double(100.0),
    ecalMatchMaxDistance=cms.double(15.0),
    hcalMatchMaxDistance=cms.double(40.0),
    # ZDC cells are coarse, but a 2 m window creates abundant accidental
    # matches. Keep a cell-scale spatial tag; do not use its shifted-frame time
    # in the combined calorimeter direction score until it is calibrated.
    zdcMatchMaxDistance=cms.double(25.0),
    caloMatchMinEnergy=cms.double(0.01),
...
shiftMuonRecoDiagnostics = cms.EDProducer(
    ...
    stripStereoRecHits=cms.InputTag("siStripMatchedRecHits", "stereoRecHit"),
    stripStereoUnmatchedRecHits=cms.InputTag("siStripMatchedRecHits", "stereoRecHitUnmatched"),
    hbheDigis=cms.InputTag("simHcalUnsuppressedDigis"),
    hfDigis=cms.InputTag("simHcalUnsuppressedDigis"),
    hoDigis=cms.InputTag("simHcalUnsuppressedDigis"),
    zdcDigis=cms.InputTag("simHcalUnsuppressedDigis"),
    hbheQIE11Digis=cms.InputTag("simHcalUnsuppressedDigis", "HBHEQIE11DigiCollection"),
    hfQIE10Digis=cms.InputTag("simHcalUnsuppressedDigis", "HFQIE10DigiCollection"),
    ecalBarrelRecHits=cms.InputTag("reducedEcalRecHitsEB"),
    ecalEndcapRecHits=cms.InputTag("reducedEcalRecHitsEE"),
    hbheRecHits=cms.InputTag("hbhereco"),
    hfRecHits=cms.InputTag("hfreco"),
    ...
    bcm1fSimHits=cms.InputTag("g4SimHits", "BCM1FHits"),
    bhmSimHits=cms.InputTag("g4SimHits", "BHMHits"),
    pltSimHits=cms.InputTag("g4SimHits", "PLTHits"),
