...
shiftMuonTable = cms.EDProducer(
    ...
    # Initial propagation gate in cm. The Kalman estimator still performs the
    # covariance-aware measurement test inside each fit iteration.
    additionalHitMaxDistance=cms.double(10.0),
...
shiftMuonRecoDiagnostics = cms.EDProducer(
    ...
    hoRecHits=cms.InputTag("reducedHcalRecHits", "horeco"),
